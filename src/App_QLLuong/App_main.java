...
//
		...
		lblNewLabel_2.setIcon(new ImageIcon(
				"E:\\APP_quanLyLuong\\App_QuanlyluongSP\\src\\Icons\\menu_left\\baseline_logout_white_24dp.png"));
		...
		btnNewButton
				.setIcon(new ImageIcon(App_main.class.getResource("/Icons/menu_left/baseline_logout_white_24dp.png")));
		btnNewButton.setSelectedIcon(
				new ImageIcon("E:\\APP_quanLyLuong\\App_QuanlyluongSP\\src\\Icons\\logo\\background.jpg"));
		btnNewButton.setForeground(new Color(255, 255, 255));
		btnNewButton.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Object o = e.getSource();
				if (JOptionPane.showConfirmDialog(null, "Bạn có muốn đăng xuất không ?", " Xác nhận",
...
//					new  CustomDialog("Thoát thành công",CustomDialog.SUCCESS_DIALOG);
					dispose();
...
//					new  CustomDialog("Bạn đã hủy thoát !",CustomDialog.WARNING_DIALOG);
	...
	public static void pQNhanSu(ArrayList<JLabel> list, int type) {
		...
		case 4: {
			...
			//ADMIN
			System.out.println("LOGIN ADDMIN !!!");
			break;
		}
		default:
			break;
