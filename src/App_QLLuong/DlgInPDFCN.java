...
//        customEvents();
	...
	private void xuLyHienThiHoaDon(BangLuongCongNhan l) {
		...
		hd += "<tr>" + "<th>Tên chuyên môn </th>" + "<th>Số lượng sản phẩm</th>" + "<th>Phụ cấp</th>"
				+ "<th>Tiền thưởng</th>" + "<th>Tiền lương</th>" + "</tr>";
//        for (Vector vec : dsGioHang) {
		hd += "<tr>";
		hd += "<td style='text-align:center;'>" + l.getCongNhan().getChuyenMon() + "</td>";
		hd += "<td style='text-align:center;'>" + (l.getCccn().getSoLuongSanPham() + l.getCccn().getSoSPGioTangCa())
				+ "</td>";
		...
		layout.setHorizontalGroup(layout.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(layout.createSequentialGroup().addGap(24)
						.addGroup(layout.createParallelGroup(Alignment.LEADING).addGroup(layout.createSequentialGroup()
								...
								.addGap(138).addComponent(lblNewLabel_4).addPreferredGap(ComponentPlacement.UNRELATED)
								...
								.addGap(25)).addGroup(
										layout.createSequentialGroup().addComponent(jLabel2)
												...
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(lblNewLabel_1, GroupLayout.PREFERRED_SIZE, 201,
														GroupLayout.PREFERRED_SIZE)
												.addContainerGap(175, Short.MAX_VALUE)))));
		layout.setVerticalGroup(layout.createParallelGroup(Alignment.LEADING).addGroup(layout.createSequentialGroup()
				.addComponent(jPanel1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.RELATED, 29, Short.MAX_VALUE)
				.addGroup(layout.createParallelGroup(Alignment.TRAILING, false).addGroup(layout.createSequentialGroup()
						.addGroup(layout.createParallelGroup(Alignment.BASELINE).addComponent(lblNewLabel_3)
								.addComponent(lblNewLabel_2).addComponent(lblNewLabel_4).addComponent(lblNewLabel_5,
						...
						.addGroup(layout.createSequentialGroup()
								.addGroup(layout.createParallelGroup(Alignment.TRAILING)
										.addComponent(lblMCn, GroupLayout.PREFERRED_SIZE, 19,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(lblCn, GroupLayout.PREFERRED_SIZE, 19,
												GroupLayout.PREFERRED_SIZE))
								.addGap(18)
