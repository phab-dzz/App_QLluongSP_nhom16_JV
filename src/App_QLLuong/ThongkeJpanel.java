...
public class ThongkeJpanel extends JPanel implements ItemListener, ActionListener {
	...
	public ThongkeJpanel() {
		...
		pblbangluong.setBorder(new TitledBorder(
				new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)),
				"B\u1EA2NG TH\u1ED0NG K\u00CA C\u00D4NG NH\u00C2N TI\u00CAU BI\u1EC2U", TitledBorder.LEADING,
		...
		cbbthang.setModel(new DefaultComboBoxModel(
				new String[] { "12", "11", "10", "09", "08", "07", "05", "04", "03", "02", "01" }));
		...
		btnreset.setIcon(new ImageIcon(ThongkeJpanel.class.getResource("/Icons/icons_sp/refresh.png")));
		...
		btnCT.setIcon(new ImageIcon(
				ThongkeJpanel.class.getResource("/Icons/icons_jplThongke/baseline_print_black_24dp.png")));
	...
	public void loaddatatotable() {
		...
		for (BangLuongCongNhan cn : dsCN) {
			if(!cn.getCccn().getMaCongNhan().equalsIgnoreCase(ma)) {
			String hoten = cn.getCongNhan().getTen();

			Object[] row = { cn.getCongNhan().getMaCongNhan(), hoten, cn.getPhuCap(), cn.getTienThuong(),
					dctt.format(cn.getThucLanh()) };
			modeltk.addRow(row);
			}
			ma=cn.getCccn().getMaCongNhan();
