...
import CustomGUi.CustomComboBoxPopup;
...
public class LuongJpanel extends JPanel implements ActionListener, MouseListener, ItemListener {
	...
	private int indexNV = -1, indexCN = -1;
...
//		cbbThang.setUI(new javax.swing.plaf.basic.BasicComboBoxUI() {
//			@Override
//			protected ComboPopup createPopup() {
//				return new CustomComboBoxPopup(comboBox);
//			}
//		});
		...
		btnChitiet.setIcon(
				new ImageIcon(LuongJpanel.class.getResource("/Icons/icons_jplThongke/details.png")));
...
//		cbbPhongBanNV.setUI(new javax.swing.plaf.basic.BasicComboBoxUI() {
//			@Override
//			protected ComboPopup createPopup() {
//				return new CustomComboBoxPopup(comboBox);
//			}
//		});
		...
		btnIn.setIcon(new ImageIcon(LuongJpanel.class.getResource("/Icons/icons_jplThongke/baseline_print_black_24dp.png")));
		...
		scrollPaneNV.setVerticalScrollBar(new ScrollBarCustom());
		...
		txtTKCN.getDocument().addDocumentListener(new DocumentListener() {
			...
			private void updateTable() {
				...
				for (BangLuongCongNhan l : ds) {
					...
					Object[] row = { stt, l.getCongNhan().getMaCongNhan(), hoten, l.getCccn().getSoLuongSanPham(),
							l.getCccn().getSoNgayNghi(), dcf.format(l.getThucLanh()) };
...
//		        	new MyDialog("Không tìm thấy thông tin nhân viên.", MyDialog.ERROR_DIALOG);
		...
		cbbNam1.setModel(new DefaultComboBoxModel(
				new String[] { "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023" }));
		cbbNam1.setBorder(null);
//		cbbNam1.setUI(new javax.swing.plaf.basic.BasicComboBoxUI() {
//			@Override
//			protected ComboPopup createPopup() {
//				return new CustomComboBoxPopup(comboBox);
//			}
...
//		cbbMaXuong.setUI(new javax.swing.plaf.basic.BasicComboBoxUI() {
//			@Override
//			protected ComboPopup createPopup() {
//				return new CustomComboBoxPopup(comboBox);
//			}
//		});
		...
		cbbThang1.setModel(new DefaultComboBoxModel(
				new String[] { "01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12" }));
		cbbThang1.setBackground(new Color(255, 255, 255));
		cbbThang1.setBorder(null);
//		cbbThang1.setUI(new javax.swing.plaf.basic.BasicComboBoxUI() {
//			@Override
//			protected ComboPopup createPopup() {
//				return new CustomComboBoxPopup(comboBox);
//			}
//		});
		...
		scrollPaneCN.setVerticalScrollBar(new ScrollBarCustom());
...
//		});
		...
		btnIn1.setIcon(new ImageIcon(LuongJpanel.class.getResource("/Icons/icons_jplThongke/baseline_print_black_24dp.png")));
...
//		pnCongNhan.add(btnTimCN);
		...
		String[] colsNV = { "STT", "Mã nhân viên", "Họ và tên", "Số ngày nghỉ", "Số giờ tăng ca", "Tiền thưởng",
				"Thực lãnh" };
		...
		txtTKNV.getDocument().addDocumentListener(new DocumentListener() {
			...
			private void updateTable() {
				...
				for (BangLuongNhanVien lcn : ds) {
					...
					Object[] row = { stt, lcn.getNv().getMaNhanVien(), hoten, lcn.getCcnv().getSoNgayNghi(),
							lcn.getCcnv().getSoGioTangCa(), lcn.getTienThuong(), dcf.format(lcn.getThucLanh()) };
...
//				new MyDialog("Vui Long chọn Nhân Viên cần xem.", MyDialog.SUCCESS_DIALOG);
			new	CustomDialog("Vui Long chọn Nhân Viên cần xem.",CustomDialog.WARNING_DIALOG);
			}
...
//				new MyDialog("Vui Lòng Chọn Công nhân cần xem.", MyDialog.SUCCESS_DIALOG);
				new	CustomDialog("Vui Long chọn Công nhân cần xem.",CustomDialog.WARNING_DIALOG);
			}
		} else if (o.equals(btnIn)) {
			if (JOptionPane.showConfirmDialog(null, "Bạn có muốn xuất danh sách Nhân viên  không?", "Xuất Excel.",
...
//				new MyDialog("Bạn đã hủy thành công", MyDialog.CANCEL_OPTION);
				new	CustomDialog("Bạn đã hủy thành công",CustomDialog.WARNING_DIALOG);
			}
...
//			new MyDialog("Nhân viên không có trong danh sách bảng lương.", MyDialog.ERROR_DIALOG);
			new CustomDialog("Nhân viên không có trong danh sách bảng lương.",CustomDialog.ERROR_DIALOG);
...
//			new MyDialog("Công nhân không có trong danh sách bảng lương.", MyDialog.ERROR_DIALOG);
			new CustomDialog("Công nhân không có trong danh sách bảng lương.",CustomDialog.ERROR_DIALOG);
	...
	private static void exportToExcel(JTable table) throws Exception {
		...
		String filePath = "D:\\XuatExcel\\BangLuong_" + generatedString + ".xlsx";
...
//				JOptionPane.INFORMATION_MESSAGE);
		new CustomDialog("Xuất file thành công!\n Xem tại thư mục \\data",CustomDialog.SUCCESS_DIALOG);
	}
